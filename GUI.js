(async () => {
    if (console.log("%c Blooket Cheats Plus %c\n	By MikeKonz on GitHub", "color: #0bc2cf; font-size: 3rem", "color: #8000ff; font-size: 1rem"), console.log("%c	gui.js", "color: #0bc2cf; font-size: 1rem"), console.log("%c	Star the github repo!%c  https://github.com/MikeKonz/Blooket-GUI", "color: #ffd000; font-size: 1rem", ""), document.querySelector("script[src*='bfs/index.js']") && !window.clearId) {
    ...
    let p, u, h, m, $, g, y, b, v, _ = l("div", {
        ...
        target: "_blank",
        href: "https://discord.gg/jbxdd_rl",
